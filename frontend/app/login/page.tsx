      ...
      <Card className="w-full max-w-md mx-4 z-10 bg-white/10 backdrop-blur-md border-white/20 shadow-2xl">
        <CardHeader className="text-center">
          ...
          <p className="text-white/80 text-sm">
            ...
            <Link href="/signup" className="text-white underline hover:text-white/80">
              Create Account
            </Link>
          </p>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="text-center">
            <Link href="/forgot-password" className="text-white/80 text-sm hover:text-white underline">
              Forgot Password?
            </Link>
          </div>
          <Button className="w-full bg-green-600 hover:bg-green-700 text-white font-semibold">Sign in</Button>
